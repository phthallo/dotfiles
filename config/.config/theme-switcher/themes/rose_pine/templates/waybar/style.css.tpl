...
@define-color second-background {{surface}};
@define-color text {{fg}};
@define-color borders {{orange}};
@define-color focused {{green_rgba}};
@define-color focused2 {{fg_dim}};
@define-color color1 {{blue}};
@define-color color2 {{lavender}};
